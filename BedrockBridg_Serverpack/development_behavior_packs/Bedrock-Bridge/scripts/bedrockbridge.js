...
import { system, world, GameMode, Player, ScriptEventSource } from '@minecraft/server';
...
import { bridgeEvents, bridge, commandArgument } from './definitions';
    ...
    for (let _0x536c38 = 0; _0x536c38 < 5; _0x536c38++) {
      try {
        ...
        if (_0x47cbf3.status >= 200) {
          let _0x3ad412 = _0x47cbf3.status == 200 ? [['login', JSON.parse(_0x47cbf3.body)]] : JSON.parse(_0x47cbf3.body);
      ...
      case 1:
        {
          ...
          try {
            ...
            this.#server_request.body = [["error", [1, _0x3dab77]]];
          }
          this.#outgoing = true;
